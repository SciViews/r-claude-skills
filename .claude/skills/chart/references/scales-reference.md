...
Comprehensive guide to ggplot2/chart scales: the functions that control how data values map to visual properties and generate axes/legends.
...
# Wrap long labels
chart(data, value ~ long_category) +
  geom_col() +
...
chart(data, y ~ x %size=% population) +
