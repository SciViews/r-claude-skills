# Chart Skill - Expert Data Visualization in R

Comprehensive Claude Code skill for mastering {chart} data visualization in R. This skill provides expert guidance on the grammar of graphics, geoms, themes, scales, and best practices for creating publication-ready plots.

## Overview

This skill transforms Claude Code into a chart expert that can:
- Generate complete, runnable chart code following best practices
...
**Total: ~9,700 lines of comprehensive chart knowledge** (nearly doubled with R Graph Gallery integration!)

## Content Sources

This skill is based on authoritative ggplot2 documentation and real-world examples, converted into chart:
...
```
User: "How do I create a scatter plot with chart?"
...
**Golden Rules**:
1. Inside aes() or the formula = variables, outside = fixed values
...
The skill is available in this project automatically when placed in `.claude/skills/chart/`.
...
cp -r .claude/skills/chart ~/.claude/skills/
```
...
### v1.0.0 (2026-03-30)
- Initial release adapted from ggplot2 skill v1.0.0 (2026-03-08) here: https://github.com/GiulSposito/r-claude-skills/tree/main/.claude/skills/ggplot2 
...
This skill documentation follows the same license as the initial ggplot2 skill and as ggplot2 (MIT). The skill itself (skill structure and organization) is provided as-is for use with Claude Code.
...
**Ready to create beautiful, accessible, publication-ready visualizations with chart!**
